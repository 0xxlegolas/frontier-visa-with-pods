...
library VisaByCharacter {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "brumpcorp", name: "VisaByCharacter", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626272756d70636f7270000000000056697361427943686172616374657200);
   ...
   * @notice Get player.
   */
  function getPlayer(uint256 characterId) internal view returns (address player) {
   ...
   * @notice Get player.
   */
  function _getPlayer(uint256 characterId) internal view returns (address player) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(characterId));
   ...
   * @notice Get player.
   */
  function get(uint256 characterId) internal view returns (address player) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(characterId));
   ...
   * @notice Get player.
   */
  function _get(uint256 characterId) internal view returns (address player) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(characterId));
   ...
   * @notice Set player.
   */
  function setPlayer(uint256 characterId, address player) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(characterId));
   ...
   * @notice Set player.
   */
  function _setPlayer(uint256 characterId, address player) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(characterId));
   ...
   * @notice Set player.
   */
  function set(uint256 characterId, address player) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(characterId));
   ...
   * @notice Set player.
   */
  function _set(uint256 characterId, address player) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(characterId));
