...
const artifactURL = gpcArtifactDownloadURL("jsdelivr", "prod", undefined);

//POD Data
const privateSigningKey =
  "2851153af6e862439ff91253684f85a6357ec7a3edcec4324de1eb7db4431ea5";
 ...
 */
export async function createVisaPod(
  SCA: string,
  expiryDate: Date,
  securityLevel: VisaStatus
) {
